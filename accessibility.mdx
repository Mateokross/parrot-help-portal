...
description: "Accessibility status for each Powerbeans product — Audio Player and Playlist are WCAG 2.2 compliant with keyboard support, ARIA labels, and focus states."
---
